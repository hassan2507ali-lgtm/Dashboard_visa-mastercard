...
export default function CreditDetail({ setCurrentPage }) {
  const [chartData, setChartData] = useState(initialCreditDetail);
  const [donutData, setDonutData] = useState(initialDonutCredit);
  ...
  const getSidebarItemStyle = (pageName) => pageName === 'credit-detail' ? "p-2.5 bg-slate-100 text-slate-800 rounded-xl cursor-pointer transition-all shadow-sm ring-1 ring-slate-200" : "p-2.5 text-gray-400 hover:text-gray-700 hover:bg-gray-50 rounded-xl cursor-pointer transition-all";
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Detail Transaksi - CREDIT</h1>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
          <div className="lg:col-span-2 bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-3"><div className="w-8 h-5 bg-gradient-to-br from-[#475569] to-[#334155] rounded flex items-center justify-center relative"><div className="w-2 h-1.5 bg-gray-300/80 rounded-[2px] absolute left-1.5 top-1"></div></div><h3 className="font-bold text-xl italic tracking-tight text-gray-900">CREDIT</h3></div>
          ...
          <div className="lg:col-span-1 bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col overflow-hidden">
            <div className="bg-[#2e5ea8] text-white text-center py-4 text-base font-bold tracking-wide shadow-inner">CREDIT 2026</div>
