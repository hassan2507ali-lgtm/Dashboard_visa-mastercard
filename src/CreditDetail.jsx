...
const generateDummyTransactions = () => {
  ...
  for (let i = 0; i < 50; i++) {
    data.push({
      ...
      principal: ['Visa', 'Master Card'][Math.floor(Math.random() * 2)],
    });
  }
  return data;
};
...
export default function CreditDetail({ onBack }) {
    ...
    <div className="flex-1 ml-[88px] p-8 overflow-y-auto h-full scroll-smooth relative">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1 max-w-4xl font-medium">Trend biaya transaksi principal khusus kartu Credit Q1 - Q6.</p>
        </div>
      </div>
          ...
          <div className="p-5 flex flex-col items-center flex-1">
            ...
            <div className="h-36 w-full relative mb-6">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-[9px] font-semibold text-gray-400 tracking-wider">TOTAL</span><span className="font-bold text-lg text-gray-900">Rp 1,879 M</span>
              </div>
            </div>
